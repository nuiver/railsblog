...
RSpec.describe PortfolioItemsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all portfolio_items as @portfolio_items" do
      portfolio_item = PortfolioItem.create! valid_attributes
  ...
  describe "GET #new" do
    it "assigns a new portfolio_item as @portfolio_item" do
      ...
      expect(assigns(:portfolio_item)).to be_a_new(PortfolioItem)
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested portfolio_item" do
        portfolio_item = PortfolioItem.create! valid_attributes
        put :update, params: {id: portfolio_item.to_param, portfolio_item: new_attributes}, session: valid_session
      ...
      it "assigns the requested portfolio_item as @portfolio_item" do
        portfolio_item = PortfolioItem.create! valid_attributes
        put :update, params: {id: portfolio_item.to_param, portfolio_item: valid_attributes}, session: valid_session
        expect(assigns(:portfolio_item)).to eq(portfolio_item)
      end
      ...
      it "redirects to the portfolio_item" do
        portfolio_item = PortfolioItem.create! valid_attributes
        put :update, params: {id: portfolio_item.to_param, portfolio_item: valid_attributes}, session: valid_session
        expect(response).to redirect_to(portfolio_item)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the portfolio_item as @portfolio_item" do
        portfolio_item = PortfolioItem.create! valid_attributes
        put :update, params: {id: portfolio_item.to_param, portfolio_item: invalid_attributes}, session: valid_session
        expect(assigns(:portfolio_item)).to eq(portfolio_item)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested portfolio_item" do
      portfolio_item = PortfolioItem.create! valid_attributes
      expect {
        delete :destroy, params: {id: portfolio_item.to_param}, session: valid_session
      }.to change(PortfolioItem, :count).by(-1)
    end
    ...
    it "redirects to the portfolio_items list" do
      portfolio_item = PortfolioItem.create! valid_attributes
      delete :destroy, params: {id: portfolio_item.to_param}, session: valid_session
      expect(response).to redirect_to(portfolio_items_url)
    end
  end
